...
class Tark implements IPreSptLoadMod, IPostDBLoadMod 
{
    ...
    constructor() 
    {
        this.mod = "idiotturdle - T.A.R.K."; // Set name of mod so we can log it to console later
        this.traderImgPath = "res/Kaliber.jpg";
    ...
    public preSptLoad(container: DependencyContainer): void 
    {
        ...
        // IMPORTANT - TRADER NEEDS A UNIQUE MONGO-ID
        // GOOGLE "mongoid generator"
        this.traderBase = {
            ...baseJson,
            _id: "67e364a0625e71fbf531678d" // This is a unique ID for our trader, also the first key in base.json
        };
