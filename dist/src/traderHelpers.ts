...
export class TraderHelper 
{
     ...
     * @param traderConfig trader config to add trader to
     * @param baseJson json file for trader (db/base.json)
     * @param refreshTimeSecondsMin How many seconds between trader stock refresh min time
     * @param refrestTimeSecondsMax How many seconds between trader stock refresh max time
     */
     ...
     * @param jsonUtil json utility database
     */
    public addTraderToDb(traderDetailsToAdd: any, tables: IDatabaseTables, jsonUtil: JsonUtil): void 
    {
        ...
        tables.traders[traderDetailsToAdd._id] = {
            ...
            base: jsonUtil.deserialize(jsonUtil.serialize(traderDetailsToAdd)) as ITraderBase, // Deserialize/serialize creates a copy of the json and allows us to cast it as an ITraderBase
            questassort: {
                started: {},
                success: {},
                fail: {}
     ...
     * @param location Location of trader (e.g. "War-torn outskirts of the Tarkov Region")
